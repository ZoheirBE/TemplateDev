...
export const setupIpcHandlers = () => {
  ...
  ipcMain.handle('file:write', async (_, params: WriteFileParams) => {
  ...
  ipcMain.handle('file:exists', async (_, params: PathParam) => {
  ...
  ipcMain.handle('readDir', async (_, dirPath: string) => {
  ...
  ipcMain.handle('log-error', async (_, { logEntry }: { logEntry: string }) => {
    try {
  ...
  // XML operations
  ipcMain.handle('xml:format', async (_, params: ContentParam) => {
    // TODO: Implement XML formatting
    return params.content;
  });

  ipcMain.handle('xml:validate', async (_, params: ContentParam) => {
